...
public class MockRepoImpl implements MockRepo {
    ...
    public List<TestEntity> findAll(Sort sort){
        ...
        Comparator<TestEntity> comparator = (o1, o2) -> o1.getExampleFieldOne().compareTo(o2.getExampleFieldOne());
    ...
    public Page<TestEntity> findAll(Pageable pageable) {
        Page<TestEntity> entityPage = new PageImpl<TestEntity>(new ArrayList<>(entityStore.values()));
        return entityPage;
    }
